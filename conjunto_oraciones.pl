% =========================================================
% CONJUNTO DE ORACIONES INICIAL
% =========================================================

oracion(1, [la, melodia, es, la, acertada, sucesion, de, varios, sonidos]).
oracion(2, [la, armonia, es, el, conjunto, de, varios, sonidos]).
oracion(3, [el, pentagrama, tiene, cinco, lineas, y, cuatro, espacios]).
oracion(4, [las, notas, musicales, son, siete]).
